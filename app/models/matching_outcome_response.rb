class MatchingOutcomeResponse < Api::Response
  ...
  SEND_SUCCESSFUL_NON_MATCHING_RESPONSE_TO_TRANSACTION = 'SEND_SUCCESSFUL_NON_MATCHING_RESPONSE_TO_TRANSACTION'.freeze
  ...
  ALLOWED_OUTCOMES = [
    ...
    SEND_SUCCESSFUL_NON_MATCHING_RESPONSE_TO_TRANSACTION
  ].freeze
